...
/*    $sort_order_sql = "SELECT MAX(sort_order) as max_sort FROM `". TABLE_CONFIGURATION ."` WHERE configuration_group_id=" . (int)$configuration_group_id;
    ...
    $sort_order =     $sort_order = array(
                array('configuration_group_id' => array('value' => $configuration_group_id,
                                                   'type' => 'integer'),
                      'configuration_key' => array('value' => 'DPU_STATUS',
                                                   'type' => 'string'),
                      'configuration_title' => array('value' => 'Dynamic Price Updater Status',
                                                   'type' => 'string'),
                      'configuration_value' => array('value' => 'false',
                                                   'type' => 'string'),
                      'configuration_description' => array('value' => 'Enable Dynamic Price Updater?',
                                                   'type' => 'string'),
                ...
                array('configuration_group_id' => array('value' => $configuration_group_id,
                      ...
                      'configuration_key' => array('value' => $module_constant . '_VERSION',
                                                   'type' => 'string'),
                      'configuration_title' => array('value' => 'Dynamic Price Updater Version',
                                                   'type' => 'string'),
                      'configuration_value' => array('value' => '3.0.5',
                                                   'type' => 'string'),
                      'configuration_description' => array('value' => 'Dynamic Price Updater version',
                                                   'type' => 'string'),
                      'date_added' => array('value' => 'NOW()',
                                                   'type' => 'noquotestring'),
                      'use_function' => array('value' => 'NULL',
                                                   'type' => 'noquotestring'),
                      'set_function' => array('value' => 'trim(',
                                                   'type' => 'string'),
                      ),
                array('configuration_group_id' => array('value' => $configuration_group_id,
                                                   'type' => 'integer'),
                      'configuration_key' => array('value' => $module_constant . '_PLUGIN_CHECK',
                                                   'type' => 'string'),
                      'configuration_title' => array('value' => 'Dynamic Price Updater Version Check?',
                                                   'type' => 'string'),
                      'configuration_value' => array('value' => 'true',
                                                   'type' => 'string'),
                      'configuration_description' => array('value' => 'Enable DPU to be able to check the ZC site for an updated copy.  Default is true.',
                                                   'type' => 'string'),
                      'date_added' => array('value' => 'NOW()',
                                                   'type' => 'noquotestring'),
                      'use_function' => array('value' => 'NULL',
                ...
                array('configuration_group_id' => array('value' => $configuration_group_id,
                                                   'type' => 'integer'),
                      'configuration_key' => array('value' => 'DPU_PRICE_ELEMENT_ID',
                                                   'type' => 'string'),
                      'configuration_title' => array('value' => 'Where to display the price',
                                                   'type' => 'string'),
                      'configuration_value' => array('value' => 'productPrices',
                                                   'type' => 'string'),
                      'configuration_description' => array('value' => 'This is the ID of the element where your price is displayed.<br /><strong>default => productPrices</strong>',
                                                   'type' => 'string'),
                      'date_added' => array('value' => 'NOW()',
                                                   'type' => 'noquotestring'),
                      'use_function' => array('value' => 'NULL',
                ...
                array('configuration_group_id' => array('value' => $configuration_group_id,
                                                   'type' => 'integer'),
                      'configuration_key' => array('value' => 'DPU_PRODUCT_FORM',
                                                   'type' => 'string'),
                      'configuration_title' => array('value' => 'Define used to set a variable for this script',
                                                   'type' => 'string'),
                      'configuration_value' => array('value' => 'cart_quantity',
                                                   'type' => 'string'),
                      'configuration_description' => array('value' => 'This should never change<br /><strong>default => cart_quantity</strong>',
                                                   'type' => 'string'),
                      'date_added' => array('value' => 'NOW()',
                                                   'type' => 'noquotestring'),
                      'use_function' => array('value' => 'NULL',
                ...
                array('configuration_group_id' => array('value' => $configuration_group_id,
                                                   'type' => 'integer'),
                      'configuration_key' => array('value' => 'DPU_WEIGHT_ELEMENT_ID',
                                                   'type' => 'string'),
                      'configuration_title' => array('value' => 'Where to display the weight',
                                                   'type' => 'string'),
                      'configuration_value' => array('value' => 'productWeight',
                                                   'type' => 'string'),
                      'configuration_description' => array('value' => 'This is the ID where your weight is displayed.<br /><strong>default => productWeight</strong>',
                                                   'type' => 'string'),
                      'date_added' => array('value' => 'NOW()',
                                                   'type' => 'noquotestring'),
                      'use_function' => array('value' => 'NULL',
                ...
                array('configuration_group_id' => array('value' => $configuration_group_id,
                                                   'type' => 'integer'),
                      'configuration_key' => array('value' => 'DPU_SHOW_LOADING_IMAGE',
                                                   'type' => 'string'),
                      'configuration_title' => array('value' => 'show a small loading graphic',
                                                   'type' => 'string'),
                      'configuration_value' => array('value' => 'true',
                                                   'type' => 'string'),
                      'configuration_description' => array('value' => 'true to show a small loading graphic so the user knows something is happening',
                                                   'type' => 'string'),
                      'date_added' => array('value' => 'NOW()',
                                                   'type' => 'noquotestring'),
                      'use_function' => array('value' => 'NULL',
                ...
                array('configuration_group_id' => array('value' => $configuration_group_id,
                                                   'type' => 'integer'),
                      'configuration_key' => array('value' => 'DPU_SHOW_CURRENCY_SYMBOLS',
                                                   'type' => 'string'),
                      'configuration_title' => array('value' => 'Show currency symbols',
                                                   'type' => 'string'),
                      'configuration_value' => array('value' => 'true',
                                                   'type' => 'string'),
                      'configuration_description' => array('value' => '',
                                                   'type' => 'string'),
                      'date_added' => array('value' => 'NOW()',
                                                   'type' => 'noquotestring'),
                      'use_function' => array('value' => 'NULL',
                ...
                array('configuration_group_id' => array('value' => $configuration_group_id,
                                                   'type' => 'integer'),
                      'configuration_key' => array('value' => 'DPU_SHOW_QUANTITY',
                                                   'type' => 'string'),
                      'configuration_title' => array('value' => 'Show product quantity',
                                                   'type' => 'string'),
                      'configuration_value' => array('value' => 'false',
                                                   'type' => 'string'),
                      'configuration_description' => array('value' => '',
                ...
                array('configuration_group_id' => array('value' => $configuration_group_id,
                                                   'type' => 'integer'),
                      'configuration_key' => array('value' => 'DPU_SECOND_PRICE',
                                                   'type' => 'string'),
                      'configuration_title' => array('value' => 'Where to display the second price',
                                                   'type' => 'string'),
                      'configuration_value' => array('value' => 'cartAdd',
                                                   'type' => 'string'),
                      'configuration_description' => array('value' => '',
                                                   'type' => 'string'),
                      'date_added' => array('value' => 'NOW()',
