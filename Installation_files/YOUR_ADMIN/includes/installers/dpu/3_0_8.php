...
$sort_order = [
  [
    'configuration_group_id' => [
      ...
      'type' => 'integer'],
    'configuration_key' => [
      'value' => 'DPU_SHOW_SIDEBOX_CURRENCY_SYMBOLS',
      'type' => 'string'],
    'configuration_title' => [
      'value' => 'Show sidebox currency symbols',
      'type' => 'string'],
    'configuration_value' => [
      'value' => 'true',
      'type' => 'string'],
    'configuration_description' => [
      'value' => 'Show currency symbols in the sidebox (when displayed).<br /><br />Default: true',
      'type' => 'string'],
    'date_added' => [
      'value' => 'NOW()',
      'type' => 'noquotestring'],
    'use_function' => [
      ...
      'type' => 'noquotestring'],
    'set_function' => [
      'value' => 'zen_cfg_select_option([\'true\', \'false\'],',
      'type' => 'string'],
  ],
];

$oldcount_sort_sql = "SELECT MAX(sort_order) AS max_sort
