...
$sort_order = [
  [
    ...
    'use_function' => [
      ...
      'type' => 'noquotestring'],
    'set_function' => [
      'value' => 'zen_cfg_select_option([\'none\', \'start_at_least\', \'start_at\', \'at_least\'],',
      'type' => 'string'],
  ],
  [
    'configuration_group_id' => [
    ...
    'use_function' => [
      ...
      'type' => 'noquotestring'],
    'set_function' => [
      'value' => 'zen_cfg_select_option([\'quantity_replace\', \'after\', \'before\', \'price_replace_only\'],',
      'type' => 'string'],
  ],
  [
    'configuration_group_id' => [
    ...
    'use_function' => [
      ...
      'type' => 'noquotestring'],
    'set_function' => [
      'value' => 'zen_cfg_select_option([\'all\', \'priced_by\'],',
      'type' => 'string'],
  ],
  [
    'configuration_group_id' => [
