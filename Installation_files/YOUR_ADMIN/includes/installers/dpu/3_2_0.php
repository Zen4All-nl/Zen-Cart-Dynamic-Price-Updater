...
$sort_order = [
                ['configuration_group_id' => ['value' => $configuration_group_id,
                                                   'type' => 'integer'],
                      'configuration_key' => ['value' => 'DPU_ATTRIBUTES_MULTI_PRICE_TEXT',
                                                   'type' => 'string'],
                      'configuration_title' => ['value' => 'Show alternate text for partial selection',
                                                   'type' => 'string'],
                      'configuration_value' => ['value' => 'start_at_least',
                                                   'type' => 'string'],
                      'configuration_description' => ['value' => 'When selections are being made that affect the price of the product, what alternate text if any should be shown to the customer.  For example if when no selections have been made, the ZC starting at text may be displayed.  When one selection of many has been made, then the text may be changed to at least this amount indicating that there are selections to be made that could increase the price.  Then once all selections have been made as expected/required the text is or should change to something like Your Price:.<br /><br /><b>Default: start_at_least</b><br /><br />start_at_least: display applicable start at or at least text<br />start_at: display start_at text until all selections have been made<br />at_least: once a selection has been made that does not complete selection display the at_least text.',
                                                   'type' => 'string'],
                      'date_added' => ['value' => 'NOW()',
                                                   'type' => 'noquotestring'],
                      'use_function' => ['value' => 'NULL',
                                                   'type' => 'noquotestring'],
                      'set_function' => ['value' => 'zen_cfg_select_option(array(\'none\', \'start_at_least\', \'start_at\', \'at_least\'),',
                                                   'type' => 'string'],
                ],
                ['configuration_group_id' => ['value' => $configuration_group_id,
                                                   'type' => 'integer'],
                      'configuration_key' => ['value' => 'DPU_SHOW_OUT_OF_STOCK_IMAGE',
                                                   'type' => 'string'],
                      'configuration_title' => ['value' => 'Show or update the display of out-of-stock',
                                                   'type' => 'string'],
                      'configuration_value' => ['value' => 'quantity_replace',
                                                   'type' => 'string'],
                      'configuration_description' => ['value' => 'Allows display of the current stock status of a product while the customer remains on the product information page and offers control about the ajax update when the product is identified as out-of-stock.<br /><br /><b>default: quantity_replace</b><br /><br />quantity_replace: if incorporated, instead of showing the quantity of product, display DPU_OUT_OF_STOCK_IMAGE.<br />after: display DPU_OUT_OF_STOCK_IMAGE after the quantity display.<br />before: display DPU_OUT_OF_STOCK_IMAGE before the quantity display.<br />price_replace_only: update the price of the product to display DPU_OUT_OF_STOCK_IMAGE',
                                                   'type' => 'string'],
                      'date_added' => ['value' => 'NOW()',
                                                   'type' => 'noquotestring'],
                      'use_function' => ['value' => 'NULL',
                                                   'type' => 'noquotestring'],
                      'set_function' => ['value' => 'zen_cfg_select_option(array(\'quantity_replace\', \'after\', \'before\', \'price_replace_only\'),',
                                                   'type' => 'string'],
                ],
                ['configuration_group_id' => ['value' => $configuration_group_id,
                                                   'type' => 'integer'],
                      'configuration_key' => ['value' => 'DPU_PROCESS_ATTRIBUTES',
                                                   'type' => 'string'],
                      'configuration_title' => ['value' => 'Modify minimum attribute display price',
                                                   'type' => 'string'],
                      'configuration_value' => ['value' => 'all',
                                                   'type' => 'string'],
                      'configuration_description' => ['value' => 'On what should the minimum display price be based for product with attributes? <br /><br />Only product that are priced by attribute or for all product that have attributes?<br /><br /><b>Default: all</b>',
                                                   'type' => 'string'],
                      'date_added' => ['value' => 'NOW()',
                                                   'type' => 'noquotestring'],
                      'use_function' => ['value' => 'NULL',
                                                   'type' => 'noquotestring'],
                      'set_function' => ['value' => 'zen_cfg_select_option(array(\'all\', \'priced_by\'),',
                                                   'type' => 'string'],
                ],
                ['configuration_group_id' => ['value' => $configuration_group_id,
                                                   'type' => 'integer'],
                      'configuration_key' => ['value' => 'DPU_PRODUCTDETAILSLIST_PRODUCT_INFO_QUANTITY',
                                                   'type' => 'string'],
                      'configuration_title' => ['value' => 'Where to display the product_quantity',
                                                   'type' => 'string'],
                      'configuration_value' => ['value' => 'productDetailsList_product_info_quantity',
                                                   'type' => 'string'],
                      'configuration_description' => ['value' => 'This is the ID where your product quantity is displayed.<br /><br /><b>default => productDetailsList_product_info_quantity</b>',
                                                   'type' => 'string'],
                      'date_added' => ['value' => 'NOW()',
                                                   'type' => 'noquotestring'],
                      'use_function' => ['value' => 'NULL',
